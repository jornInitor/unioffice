...
import (
	...
	"github.com/jornInitor/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/jornInitor/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/jornInitor/unioffice
